...
@section('navmenu')
    <ul class="nav nav-pills">
        ...
        <li class="active"><a href="{{ route('withdrawal') }}" >Withdraw</a></li>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="inbox-status">
                            <ul class="inbox-st-nav inbox-ft">
                                <li><a data-toggle="tab" href="#menu1" aria-expanded="true"><i class="notika-icon notika-dollar"></i> Withdraw</a></li>
                            </ul>
                        </div>
                    </div>
